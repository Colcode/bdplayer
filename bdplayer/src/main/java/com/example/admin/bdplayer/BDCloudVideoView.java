...
//            super.handleMessage(msg);
    ...
    private void addCachingHintView() {
        ...
        LinearLayout load = new LinearLayout(this.getContext());
        ...
        View contentView = mInflater.inflate(R.layout.item_prepare_load, null);
        cachingProgressBar = contentView.findViewById(R.id.loading);
        ...
        Drawable d = this.getResources().getDrawable(R.drawable.bd_buffing);
        cachingProgressBar.setIndeterminateDrawable(d);
        cachingProgressHint = contentView.findViewById(R.id.loading_text);
        ...
        cachingHintViewRl.addView(contentView, rllp);
    }
